...
public class SeleniumGrid {
    ...
    static class TestClass3 implements Runnable {
        public void run() {
            Hashtable<String, String> capsHashtable = new Hashtable<String, String>();
    ...
    static class mainTestClass {
        public static final String USERNAME = "ngngc_oC6VRw";
        public static final String AUTOMATE_KEY = "p3Ag6tJAsAD1gKkpymLh";
