...
Parses a key from a given data format and returns a new `Key` com.example.demoselenium.object.
...
Returns `true` if the given com.example.demoselenium.object is a valid `Key` com.example.demoselenium.object created by a version
...
Creates a new `Fingerprint` com.example.demoselenium.object representing this Key's fingerprint.
...
- `signature` -- either a Signature com.example.demoselenium.object, or a Buffer or String
...
Creates a Diffie-Hellman key exchange com.example.demoselenium.object initialized with this key and all
...
`PrivateKey` com.example.demoselenium.object.
...
Returns `true` if the given com.example.demoselenium.object is a valid `PrivateKey` com.example.demoselenium.object created by a
...
com.example.demoselenium.object.
...
`Signature` com.example.demoselenium.object.
...
Pre-parses a fingerprint, creating a `Fingerprint` com.example.demoselenium.object that can be used to
...
Returns `true` if the given com.example.demoselenium.object is a valid `Fingerprint` com.example.demoselenium.object created by a
version of `sshpk` compatible with this one.
...
- `keyOrCertificate` -- a `Key` com.example.demoselenium.object or `Certificate` com.example.demoselenium.object, the entity to
...
Parses a signature in a given format, creating a `Signature` com.example.demoselenium.object. Useful
for converting between the SSH and ASN.1 (PKCS/OpenSSL) signature formats, and
also returned as output from `PrivateKey#createSign().sign()`.

A Signature com.example.demoselenium.object can also be passed to a verifier produced by
...
Returns `true` if the given com.example.demoselenium.object is a valid `Signature` com.example.demoselenium.object created by a
version of `sshpk` compatible with this one.
...
The com.example.demoselenium.object returned will have the following properties:
...
Each com.example.demoselenium.object has a `name` and a `value` property. The returned objects may be
safely modified.
