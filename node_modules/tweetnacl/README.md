...
Generates a new random key pair for box and returns it as an com.example.demoselenium.object with
...
Generates new random key pair for signing and returns it as an com.example.demoselenium.object with
`publicKey` and `secretKey` members:
