...
{{? ($schema || $isData) && it.opts.uniqueItems !== false }}
  ...
  if (i > 1) {
    ...
    {{? !$itemType || $itemType == 'com.example.demoselenium.object' || $itemType == 'array' ||
        ($typeIsArray && ($itemType.indexOf('com.example.demoselenium.object') >= 0 || $itemType.indexOf('array') >= 0)) }}
      outer:
      for (;i--;) {
        for (j = i; j--;) {
