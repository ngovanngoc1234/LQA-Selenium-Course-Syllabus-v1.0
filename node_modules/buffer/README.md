...
- [`is-buffer`](https://www.npmjs.com/package/is-buffer) - Determine if an com.example.demoselenium.object is a Buffer without including the whole `Buffer` package
