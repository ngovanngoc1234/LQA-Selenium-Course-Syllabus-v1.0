...
com.example.demoselenium.objecom.example.demoselenium.object opts = { host: 'my-bucket.s3.us-west-1.amazonaws.com', path: com.example.demoselenium.object, service: 's3', region: 'us-west-1' }

com.example.demoselenium.object4.sign() will sign and modify these options, ready to pass to http.request
...
opts = { host: 'my-bucket.s3.us-west-1.amazonaws.com', path: com.example.demoselenium.object }

// usually it wilcom.example.demoselenium.objectmodify request headers, but you can also sign the query:
...
`requestOptions` is an object holding the same opticom.example.demoselenium.objectat the Node.js
