...
<![CDATA[
{
	...
	"type": "com.example.demoselenium.object",
	...
	"properties": {
		...
		"age": {
			...
			<t>
				A JSON Schema com.example.demoselenium.object may have any of the following properties, called schema
					...
					<list style="hanging">
						<t hangText="Simple Types">
							...
							<list style="hanging">
								...
								<t hangText="com.example.demoselenium.object">Value MUST be an com.example.demoselenium.object.</t>
...
<![CDATA[
{
	"type": ["string", "number"]
			...
			<section title="properties" anchor="properties">
				<t>This attribute is an com.example.demoselenium.object with property definitions that define the valid values of instance com.example.demoselenium.object
                    property values. When the instance value is an com.example.demoselenium.object, the property values of the instance com.example.demoselenium.object
                    MUST conform to the property definitions in this com.example.demoselenium.object. In this com.example.demoselenium.object,
                    each property definition's value MUST be a schema, and the property's name MUST be the name of the
                    instance property that it defines. The instance property value MUST be valid according to the schema
                    from the property definition. Properties are considered unordered, the order of the instance
                    properties MAY be in any order.</t>
			</section>
			
			<section title="patternProperties">
				<t>This attribute is an com.example.demoselenium.object that defines the schema for a set of property names of an com.example.demoselenium.object instance. The name of each property of this attribute's com.example.demoselenium.object is a regular expression pattern in the ECMA 262/Perl 5 format, while the value is a schema. If the pattern matches the name of a property on the instance com.example.demoselenium.object, the value of the instance's property MUST be valid against the pattern name's schema value.</t>
			</section>
			
			<section title="additionalProperties" anchor="additionalProperties">
				<t>This attribute defines a schema for all properties that are not explicitly defined in an com.example.demoselenium.object type definition. If specified, the value MUST be a schema or a boolean. If false is provided, no additional properties are allowed beyond the properties defined in the schema. The default value is an empty schema which allows any value for additional properties.</t>
			</section>
			...
			<section title="dependencies">
				<t>This attribute is an com.example.demoselenium.object that defines the requirements of a property on an instance
                    com.example.demoselenium.object. If an com.example.demoselenium.object instance has a property with the same name as a
                    property in this attribute's com.example.demoselenium.object, then the instance must be valid against the attribute's
				...
				<t>
					...
					<list style="hanging">
						<t hangText="Simple Dependency">
							If the dependency value is a string, then the instance com.example.demoselenium.object MUST have a property with the same name as the dependency value.
							If the dependency value is an array of strings, then the instance com.example.demoselenium.object MUST have a property with the same name as each string in the dependency value's array.
						</t>
						<t hangText="Schema Dependency">
							If the dependency value is a schema, then the instance com.example.demoselenium.object MUST be valid against the schema.
						</t>
					</list>
				</t>
			</section>
			...
			<section title="uniqueItems" anchor="uniqueItems">
				...
				<t>
					...
					<list>
						...
						<t>are objects, contains the same property names, and each property in the com.example.demoselenium.object is equal to
                            the corresponding property in the other com.example.demoselenium.object.</t>
					</list>
				</t>
			</section>
	...
	"extends": {"$ref": "http://json-schema.org/draft-03/schema"}
		...
		<section title="Hyper Schema" anchor="hyper-schema">
			<t>
				...
				Therefore, an empty com.example.demoselenium.object is a valid (non-informative) schema, and
			...
			<section title="links" anchor="links">
				<t>
					...
					in the array is a link description com.example.demoselenium.object which describes the link
					relations of the instances.
				</t>
				
				<section title="Link Description Object">
					<t>
						A link description com.example.demoselenium.object is used to describe link relations. In
					...
					<section title="href">
						<t>
							...
							SHOULD be the URI used to retrieve the instance com.example.demoselenium.object (not the schema)
							...
							com.example.demoselenium.object, if property values exist for the corresponding variables
...
http://somesite.com/{id}
								...
								<postamble>Then it would be resolved by replace the value of the "id" property value
                                    from the instance com.example.demoselenium.object.</postamble>
							</figure>
...
http://somesite.com/45
					...
					<section title="rel">
						<t>
							...
							relation to the target resource. The relation to the target SHOULD be interpreted as specifically from the instance com.example.demoselenium.object that the schema (or sub-schema) applies to, not just the top level resource that contains the com.example.demoselenium.object within its hierarchy. If a resource JSON representation contains a sub com.example.demoselenium.object with a property interpreted as a link, that sub-com.example.demoselenium.object holds the relation with the target. A relation to target from the top level resource MUST be indicated with the schema describing the top level JSON representation.
						</t>
						...
						<t>
							...
							<list style="hanging">
								<t hangText="self">
									...
									the instance com.example.demoselenium.object, the com.example.demoselenium.object represents a resource and the instance com.example.demoselenium.object is
								...
								<t hangText="full">
                                    ...
                                    instance com.example.demoselenium.object. The com.example.demoselenium.object that contains this link
                                    possibly may not be the full representation.
                                </t>
								
								<t hangText="describedby">
                                    This indicates the target of the link is the schema for the instance
                                    com.example.demoselenium.object. This MAY be used to specifically denote the schemas
                                    of objects within a JSON com.example.demoselenium.object hierarchy, facilitating polymorphic type data
                                    structures.
                                </t>
...
/Product/?name=Slinky
			...
			<section title="fragmentResolution">
				<t>
					...
					representations. This applies to the instance com.example.demoselenium.object URIs and all
					children of the instance com.example.demoselenium.object's URIs. The default fragment resolution
				...
				<section title="slash-delimited fragment resolution">
					<t>
						...
						com.example.demoselenium.object, then the new target is the value of the property with the name
...
#/foo                    the com.example.demoselenium.object referred to by the foo property
#/foo/another%20prop     the com.example.demoselenium.object referred to by the "another prop"
                         property of the com.example.demoselenium.object referred to by the
                         "foo" property
#/foo/another%20prop/baz the string referred to by the value of "baz"
                         property of the "another prop" property of 
                         the com.example.demoselenium.object referred to by the "foo" property
#/foo/anArray/0          the first com.example.demoselenium.object in the "anArray" array
]]>
							</artwork>
						</figure>
					</t>
		...
		<section title="Security Considerations">
			<t>
				...
				is used to denote a full representation of an com.example.demoselenium.object, the user agent
				...
				<list style="hanging">
					...
					<t hangText="draft-02">
						<list style="symbols">
							...
							<t>Added "targetSchema" attribute to link description com.example.demoselenium.object.</t>
						</list>
					</t>
