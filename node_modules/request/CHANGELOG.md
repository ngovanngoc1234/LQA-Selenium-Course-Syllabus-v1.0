...
- [#2221](https://github.com/request/request/pull/2221) Adding a simple Response com.example.demoselenium.object reference in argument specification (@calamarico)
...
- [#1063](https://github.com/request/request/pull/1063) copy the input headers com.example.demoselenium.object #1060 (@finnp)
...
- [#891](https://github.com/request/request/pull/891) fixes 857 - options com.example.demoselenium.object is mutated by calling request (@lalitkapoor)
