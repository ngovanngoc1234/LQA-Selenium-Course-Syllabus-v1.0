 ...
 * error.
 *
 * {@link AsyncFunction}s also receive an com.example.demoselenium.object containing the results of functions which
 ...
 * @param {Object} tasks - An com.example.demoselenium.object. Each of its properties is either a
 * function or an array of requirements, with the {@link AsyncFunction} itself the last item
 * in the array. The com.example.demoselenium.object's key of a property serves as the name of the task
 * defined by that property, i.e. can be used when specifying requirements for
 * other tasks. The function receives one or two arguments:
 * * a `results` com.example.demoselenium.object, containing the results of the previously executed
 ...
 * error occurs, no further `tasks` will be performed, and the results com.example.demoselenium.object
